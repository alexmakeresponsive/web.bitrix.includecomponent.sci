...
class CBitrixComponentTemplate
{
	...
	{
		// die('InitTemplateEngines?');
		global $arBXAvailableTemplateEngines, $arBXRuntimeTemplateEngines;

		// echo "<pre>";
		// var_dump($arBXAvailableTemplateEngines);
		// var_dump($arBXRuntimeTemplateEngines);
		// var_dump($GLOBALS);
		// die;
		...
		Collection::sortByColumn($arBXAvailableTemplateEngines, "sort", "", 200);
		// die('after sort');
		...
		// var_dump($arBXRuntimeTemplateEngines);die('arBXRuntimeTemplateEngines');
	}
	...
	{
		// die('cbitrixcomponenttemplate Init?');
		global $arBXRuntimeTemplateEngines;

		$this->__bInited = false;

		// var_dump($siteTemplate);die;	//twbs4_1
		...
		// var_dump(strlen($this->__siteTemplate) <= 0);die('strlen < 0');	//false
		...
		// die('after engine init');

		// var_dump($component instanceof cbitrixcomponent);die;	//true
		...
		if (!self::CheckName($this->__name))
			$this->__name = ".default";
		// die('after check name');

		// var_dump($this->__component);die;
		$this->__page = $this->__component->GetTemplatePage();
		// var_dump($this->__page);die;
