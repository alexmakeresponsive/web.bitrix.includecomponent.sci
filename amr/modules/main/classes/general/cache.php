...
class CCacheManager
{
	...
	public function __construct()
	{
		...
		// var_dump($this->managedCache);
		$this->taggedCache = $app->getTaggedCache();
		// var_dump($this->taggedCache);

		// die('CCacheManager const end');
	}
...
// var_dump($CACHE_MANAGER);die;	//object(CCacheManager)#16 (2)
...
// die('before new CStackCacheManager');
