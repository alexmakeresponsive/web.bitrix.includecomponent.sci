...
use Amr\Main\Lib\Request;
use Amr\Main\Lib\Type\ParameterDictionary;
use Amr\Main\Lib\Config\Option;
...
class HttpRequest extends Request
{
	...
	public function __construct(Server $server, array $queryString, array $postData, array $files, array $cookies)
	{
		...
		// echo "<pre>";
		// var_dump($this->queryString);die('qs?');
		...
		$this->headers 		= new ParameterDictionary($this->fetchHeaders($server));
	}
	...
	protected function prepareCookie(array $cookies)
	{
		...
		if ($cookiePrefix === null)
			$cookiePrefix = Option::get("main", "cookie_name", "BITRIX_SM")."_";
